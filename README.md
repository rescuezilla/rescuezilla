...
| ------------------- | ---------- | ---------------- | ---------------------------------- |
| Rescuezilla Rolling | 2022-XX-XX | Ubuntu 21.10     | Weekly rolling release with upcoming features and translations [Download page](https://github.com/rescuezilla/rescuezilla/releases)
